...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 28.520253, lng: 77.240914, zoom: 13, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 28.520253, lng: 77.240914, title: 'Umesh Mishra',
      infoWindow: { content: '<p>Umesh Mishra, New Delhi, India</p>' } });
